...
class BlockchainService {
  ...
  async testContractConnection() {
    try {
      ...
      console.log(`✅ Contract test successful. Total donations on chain: ${totalDonations.length}`);
    } catch (error) {
  ...
  // ========================================
  // EXISTING FUNCTIONS (your current implementations)
  // ========================================
  ...
  async recordDonation(donation) {
    try {
      ...
      // Convert amount to wei (using 2 decimals as in your original)
  ...
  // ========================================
  // NEW SMART CONTRACT STATISTICS FUNCTIONS
  // ========================================

  // Platform-wide statistics from smart contract
  ...
  // Recent donations from smart contract
  ...
  // Top charities by donations from smart contract
  ...
  // Charity-specific statistics from smart contract
  ...
  // Charity donation history from smart contract
  ...
  // Donor-specific statistics from smart contract
  ...
  // Donor donation history from smart contract
  ...
  // Get single donation from smart contract
  ...
  // Get donations by donor from smart contract
  ...
  // Get all donation IDs from smart contract
  ...
  // Allocate funds (for admins/charity managers)
